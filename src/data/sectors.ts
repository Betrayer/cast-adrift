...
export const SECTORS: readonly SectorDef[] = [
  ...
  },
  {
    ...
    encounter: {
      bespokeWeight: 12,
      threatCap: 30,
      sizeWeights: [2.6, 2.6, 0.9],
    },
    shape: SHAPES[2],
    scaling: { hpPct: 3, dmgPct: 30, pocketPct: 25 },
    scrapMult: 1.1,
  ...
  },
  {
    ...
    encounter: {
      bespokeWeight: 12,
      threatCap: 38,
      sizeWeights: [3.4, 2.3, 0.5],
    },
    shape: SHAPES[3],
    scaling: { hpPct: 19, dmgPct: 46, pocketPct: 25 },
    scrapMult: 1.25,
  ...
  },
  {
    ...
    encounter: {
      bespokeWeight: 12,
      threatCap: 46,
      sizeWeights: [3.7, 2.5, 0.6],
    },
    shape: SHAPES[4],
    scaling: { hpPct: 38, dmgPct: 54, pocketPct: 30 },
    scrapMult: 1.2,
    beaconId: "pactSeal",
  },
  {
    ...
    encounter: {
      bespokeWeight: 12,
      threatCap: 54,
      sizeWeights: [4.0, 2.5, 0.45],
    },
    shape: SHAPES[5],
    scaling: { hpPct: 126, dmgPct: 62, pocketPct: 30 },
    scrapMult: 1.25,
